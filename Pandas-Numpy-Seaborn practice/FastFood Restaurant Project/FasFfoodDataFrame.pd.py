...
df = pd.read_csv("C:\\Users\\admin\\OneDrive\\Documents\\GitHub\\AI-Course\\Pandas-Numpy-Seaborn practice\\FastFood Restaurant Project\\FastFoodRestaurantsV2.csv", delimiter=",")
...
rows_2 = df.loc[df['name'] == "Domino's Pizza"]
print("Conditional selection of rows :" , rows_2)

rows_3 = df.loc[:1, 'name']
print("selecting single coloumn:" , rows_3)

rows_4 = df.loc[:2 ,['country' , 'province']]
print("selecting multiple coloumns:" , rows_4)

rows_5 = df.loc[:1 , 'country' : 'province']
print("selecting slice of coloumns :" , rows_5)

rows_6 = df.loc[df['name'] == "Domino's Pizza" , 'keys' : 'postalcode']
print("Combined row and coloumn selection :" , rows_6)
print()

# CASE 2 : using .loc with index_col

df_index_col = pd.read_csv("C:\\Users\\admin\\OneDrive\\Documents\\GitHub\\AI-Course\\Pandas-Numpy-Seaborn practice\\FastFood Restaurant Project\\FastFoodRestaurantsV2.csv", delimiter=",")
...
# add a new row
# 6098 State Highway 37,Massena,US,us/ny/massena/6098statehighway37/-1161002137,44.95008,-74.84553,McDonald's,13662,NY,"http://mcdonalds.com,http://www.mcdonalds.com/?cid=RF:YXT_FM:TP::Yext:Referral"                              

df.loc[len(df.index)] = ["6098 State Highway 37" , " Massena " , " UK " , "us/ny/massena/6098 state highway37/-1161002137" , 44.95008 , -73.84553 , "KFC" , 13662 , "NY" , "http://kfc.com,http://www.kfc.com/?cid=RF:YXT_FM:TP::Yext:Referral"]  
...
# delete latitute and longitute coloumn
...
df.rename(mapper={'name' : 'new_name' , 'province' : 'new_province'} , axis=1 , inplace=True)
print("Modified DataFrame :")
print(df)
...
selected_rows = df.query("new_province == 'NY' or new_name == \"McDonald's\"")
print(selected_rows.to_string())
print(len(selected_rows))

# sort DataFrame by price in ascending order
sorted_df = df.sort_values(by='new_name')
print(sorted_df.to_string(index=False))

df1 = df.sort_values(by=['address' , 'websites'])
print(df1.to_string(index=False))   

# group by operations 
grouped = df.groupby('new_name')['postalCode'].sum()
