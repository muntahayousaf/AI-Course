...
industry , funding_rounds , investment_amount , country , growth_rate  = np.genfromtxt("C:\\Users\\admin\\OneDrive\\Documents\\GitHub\\AI-Course\\Pandas-Numpy-Seaborn practice\\Startup Growth Investment project\\startup_growth_investment_data.csv" ,
