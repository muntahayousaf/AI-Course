...
df = pd.read_csv("C:\\Users\\admin\\OneDrive\\Documents\\GitHub\\AI-Course\\Pandas-Numpy-Seaborn practice\\Real Estate project\\realestateV1_data.csv" , delimiter= ",")
...
rows_4 = df.loc[:2 ,['bed' , 'bath']]
print("selecting multiple coloumns:" , rows_4)

rows_5 = df.loc[:1 , 'bed' : 'bath']
...
df_index_col = pd.read_csv("C:\\Users\\admin\\OneDrive\\Documents\\GitHub\\AI-Course\\Pandas-Numpy-Seaborn practice\\Real Estate project\\realestateV1_data.csv" , delimiter= ",")
...
df.loc[len(df.index)] = [103378, "for_sale", 105000, 3 , 2, 0.12 , 
                          1962661, "Adjuntas", "Puerto Rico", 601, 920 , None]
